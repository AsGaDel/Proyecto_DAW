  ...
  return (
    <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm hover:shadow-md hover:border-gray-300 transition-all duration-200">
      ...
      <div className="grid grid-cols-3 gap-2 mb-4">
        ...
        <div className="bg-gray-50 rounded-lg p-2 text-center">
          <p className="text-sm font-black text-gray-800">{stats.suscritos}</p>
          <p className="text-xs text-gray-400 leading-tight">Suscritos</p>
        </div>
      </div>
      ...
      {!confirmDelete
        ? (
          <div className="flex gap-2">
            ...
            {/* 4. Cambiar el onClick para abrir el modal */}
            <button
