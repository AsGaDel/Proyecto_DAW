  ...
  export function Dropdown({ trigger, children, align = "right", width = "w-32" }) {
    ...
    return (
      <div className="relative" ref={ref}>
        ...
        {/* Menú */}
        {open && (
          <div className={`absolute ${alignClass} mt-2 ${width} bg-white border-gray-200 rounded-lg shadow-lg z-[100] overflow-hidden`}>
            {children}
          </div>
        )}
      </div>
