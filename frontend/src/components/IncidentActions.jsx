...
export default function IncidentActions({ incidentId }) {
  ...
  return (
    <div className="flex items-center gap-3 pt-2">
      ...
      {/* Votar */}
      <button onClick={handleVote} className={`flex items-center gap-2 px-4 py-2.5 rounded-lg text-sm font-semibold border transition-all duration-150
          ${voted
      ...
      {/* Suscribirse */}
      <button onClick={handleSubscribe} className={`flex items-center gap-2 px-4 py-2.5 rounded-lg text-sm font-semibold border transition-all duration-150
          ${subscribed
