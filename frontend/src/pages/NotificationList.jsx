...
const initialNotifications = [
  { id: 1,  text: "carlos_m ha comentado en tu incidente.",              date: new Date("2026-04-28T10:15:00"), read: false, type: "comment",  incident: { id: 1, name: "Bache en la calle" }  },
  { id: 2,  text: "Tu incidente 'Bache en la calle' ha sido resuelto.",  date: new Date("2026-04-27T18:30:00"), read: false, type: "resolved", incident: { id: 1, name: "Bache en la calle" } },
  { id: 3,  text: "laura_g ha votado tu incidente.",                     date: new Date("2026-04-27T09:00:00"), read: true,  type: "vote",     incident: { id: 2, name: "Señal de tráfico caída" }     },
  { id: 4,  text: "Nuevo incidente en tu zona: 'Farola caída'.",         date: new Date("2026-04-26T14:20:00"), read: true,  type: "new",      incident: { id: 1, name: "Bache en la calle" }      },
  { id: 5,  text: "pedro_r ha comentado en tu incidente.",               date: new Date("2026-04-25T11:00:00"), read: true,  type: "comment",  incident: { id: 2, name: "Señal de tráfico caída" }  },
  { id: 6,  text: "Tu incidente 'Acera en mal estado' tiene 10 votos.",  date: new Date("2026-04-24T08:45:00"), read: true,  type: "vote",     incident: { id: 1, name: "Bache en la calle" }     },
  { id: 7,  text: "ana_s se ha suscrito a tu incidente.",                date: new Date("2026-04-23T16:30:00"), read: true,  type: "subscribe",incident: { id: 2, name: "Señal de tráfico caída" } },
  { id: 8,  text: "Nuevo incidente en tu zona: 'Alcantarilla sin tapa'.",date: new Date("2026-04-22T12:00:00"), read: true,  type: "new",      incident: { id: 1, name: "Bache en la calle" }      },
];
...
export default function NotificationList() {
  ...
  const markAllRead = () => {
    ...
    // TODO: await notificationService.markAllRead();
  };

  const markRead = (id) => {
    setNotifications((prev) => prev.map((n) => n.id === id ? { ...n, read: true } : n));
    // TODO: await notificationService.markRead(id);
  };

  const deleteNotification = (id) => {
    setNotifications((prev) => prev.filter((n) => n.id !== id));
    // TODO: await notificationService.delete(id);
  };
